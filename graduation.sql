...
CREATE TABLE `class_info`  (
  ...
  CONSTRAINT `class_info_ibfk_1` FOREIGN KEY (`grade_id`) REFERENCES `grade` (`grade_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `class_info_ibfk_2` FOREIGN KEY (`subject_id`) REFERENCES `subject` (`subject_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `dabian`  (
  ...
  CONSTRAINT `dabian_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `dicts`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据字典' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ktbg`  (
  ...
  INDEX `student_id`(`student_id`) USING BTREE,
  CONSTRAINT `ktbg_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `lunwen`  (
  ...
  INDEX `student_id`(`student_id`) USING BTREE,
  CONSTRAINT `lunwen_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mangsheng`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `student_id`(`student_id`) USING BTREE,
  CONSTRAINT `mangsheng_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `mdb`  (
  ...
  INDEX `student_id`(`student_id`) USING BTREE,
  CONSTRAINT `mdb_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- Records of project
-- ----------------------------
INSERT INTO `project` VALUES (1, '毕设管理系统', '毕设管理系统', 1, 'b1f4f5972541435bacbfd7de7d3422ce', '182d39231cb3413e881d76b21a3fd393');
...
INSERT INTO `project` VALUES (6, '2022你好', '你好好', 1, '2f65cde569194dd4bda7259c98b883af', NULL);
INSERT INTO `project` VALUES (7, '都是啥多', '时尚大师大所多', 2, '2f65cde569194dd4bda7259c98b883af', NULL);
...
CREATE TABLE `student`  (
  ...
  CONSTRAINT `student_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `student_ibfk_3` FOREIGN KEY (`project_id`) REFERENCES `project` (`project_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `student_ibfk_5` FOREIGN KEY (`class_id`) REFERENCES `class_info` (`class_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `student_ibfk_6` FOREIGN KEY (`yansou_team_id`) REFERENCES `yansou_team` (`yansou_team_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('182d39231cb3413e881d76b21a3fd393', 1, 0, 1, 'b1f4f5972541435bacbfd7de7d3422ce', 'bd5d63c3be7f46cca824db25de1600c9', 1, NULL, NULL, NULL);
...
CREATE TABLE `user`  (
  ...
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`user_roles`) REFERENCES `roles` (`roles_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('4fe0e48ffdf34530a08c33dce567376e', '张老师', '100110', 'e10adc3949ba59abbe56e057f20f883e', '18337953710', 1, '../img/maoli.jpg', 1);
INSERT INTO `user` VALUES ('56058e923178421c91127ed16c8dd008', '素还真', '999666', 'e10adc3949ba59abbe56e057f20f883e', '', 1, '', 2);
INSERT INTO `user` VALUES ('7783519cfde84877a7d9db909c2996cf', '路飞', '778899', 'e10adc3949ba59abbe56e057f20f883e', '10883795310', 1, '../img/lufei.jpg', 2);
INSERT INTO `user` VALUES ('848572f7312e4470a26257727af2a369', '王管理员', '111111', 'e10adc3949ba59abbe56e057f20f883e', '123456', 0, NULL, 3);
INSERT INTO `user` VALUES ('9671bac9eda74d058b8cc11308e80e8e', '陈老师', '999999', 'e10adc3949ba59abbe56e057f20f883e', '18337953729', 1, '../img/leili.jpg', 1);
INSERT INTO `user` VALUES ('ac901d879c054023bbe396504c125e50', '李展', '141164514', 'e10adc3949ba59abbe56e057f20f883e', '18300000000', 1, '../img/wo.png', 2);
INSERT INTO `user` VALUES ('bd5d63c3be7f46cca824db25de1600c9', '索隆', '000000', 'e10adc3949ba59abbe56e057f20f883e', '18337953700', 1, '../img/suolong.jpg', 2);
INSERT INTO `user` VALUES ('c1f4a807b7a14b95a7fb4541c259177f', '高老师', '222222', 'e10adc3949ba59abbe56e057f20f883e', '18337953722', 1, '../img/zlaiye.jpg', 1);
INSERT INTO `user` VALUES ('c31a826c1b4c4315b6df48bc97d58454', '刘老师', '888888', 'e10adc3949ba59abbe56e057f20f883e', '18337953728', 1, '../img/luojiejpg.jpg', 1);
INSERT INTO `user` VALUES ('c5835ac820e6406dab23baa5bb446c7a', '甘老师', '112233', 'e10adc3949ba59abbe56e057f20f883e', '18337953766', 0, '../img/gan.png', 1);
INSERT INTO `user` VALUES ('c58dd3d32fac48ccbb82da9e18a9c4bf', '赵老师', '123321', 'e10adc3949ba59abbe56e057f20f883e', '18337953725', 1, NULL, 1);
INSERT INTO `user` VALUES ('d38bf5f29fab4dbcacb84e2fe56a353f', '孙老师', '777777', 'e10adc3949ba59abbe56e057f20f883e', '18337353727', 0, NULL, 1);
INSERT INTO `user` VALUES ('dd8909d0931449eebe6367179f40cbe2', '李刚老师', '666666', 'e10adc3949ba59abbe56e057f20f883e', '18337953723', 1, NULL, 1);
INSERT INTO `user` VALUES ('e7b6d96d15204b75aaaae4a2fc162287', '李丽老师', '777777', 'e10adc3949ba59abbe56e057f20f883e', '18337953724', 0, NULL, 1);
...
CREATE TABLE `yansou_teacher`  (
  ...
  INDEX `yansou_team_id`(`yansou_team_id`) USING BTREE,
  INDEX `teacher_id`(`teacher_id`) USING BTREE,
  CONSTRAINT `yansou_teacher_ibfk_1` FOREIGN KEY (`yansou_team_id`) REFERENCES `yansou_team` (`yansou_team_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `yansou_teacher_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`teacher_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `zqjc`  (
  ...
  INDEX `student_id`(`student_id`) USING BTREE,
  CONSTRAINT `zqjc_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
